        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <p className="font-inter text-[15px] text-white/70 leading-relaxed mb-6 max-w-[280px]">
              Bringing dental care, education, and preventive health to underserved communities across Belize.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li><a href="#ambassador" className="font-inter text-[15px] text-white/70 hover:text-brand-sky transition-colors flex items-center gap-2 group"><span className="w-1 h-1 rounded-full bg-brand-sky opacity-0 group-hover:opacity-100 transition-opacity"></span> About Faith</a></li>
            </ul>
          </div>
